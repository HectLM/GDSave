...
function listCreatedLevels(levelList) {
        ...
        levelList.forEach((x, n) => {
            ...
            <div class="createdLevelButton">
                ...
                ${levelDetail("Duration", x.ticksToComplete ? levelTime(Math.round(x.ticksToComplete / 240)) : "--")}
                ${levelDetail("Best Time", x.bestTime ? levelTime(Math.round(x.bestTime / 1000)) : "--")}
                ...
                ${levelDetail("Requested Stars", x.requestedStars || "--")}
                ...
                ${levelDetail("Unlisted", x.unlisted ? (x.friendsOnly ? "Friends only" : "Yes") : "No")}
                ...
                ${levelDetail("Songs", x.usedSongs ? x.usedSongs.split(",").length : 0)}
                ${levelDetail("SFX", x.usedSFX ? x.usedSFX.split(",").length : 0)}
