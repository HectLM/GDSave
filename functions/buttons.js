...
function loadButtons() {
    ...
    $('#saveLevelFilters').click(function() {
        ...
        addFilter(y => (si.buggedID && y.buggedID) || (si.id && !y.name && !y.buggedID) || (si.metadata && y.name && !y.hasLevelData && !y.buggedID) || (si.leveldata && y.hasLevelData))
